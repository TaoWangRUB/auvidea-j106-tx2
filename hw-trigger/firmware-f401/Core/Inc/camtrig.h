...
/* TIM2_CH1..CH4 on PA0 / PA1 / PA2 / PA3, all AF2.
 *
 ...
 * unusable.  TIM2's channels land on PA0-PA3, which this board leaves entirely
 * free, and the swap costs nothing: the optocouplers are not wired yet.
 *
 * TIM2 is also a 32-bit counter, unlike TIM1.  The auto-prescaler therefore
 ...
 * (3V3 -> R5 1.5K -> LED -> PC13).  Named in main.h. */
